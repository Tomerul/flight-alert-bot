  ...
  try {
    ...
    if (!offers.length && resData.best) {
      ...
      offers = [{
        ...
        origin: route.origin, destination: route.destination, adults: route.adults
      }];
    }
    ...
    if (offers.length) {
      ...
      offersBox.innerHTML = `
        <table>
          <thead><tr><th>#</th><th>חברת תעופה</th><th>יציאה</th><th>חזרה</th><th>מחיר</th><th>לינק</th></tr></thead>
          <tbody>${rows}</tbody>
        </table>
